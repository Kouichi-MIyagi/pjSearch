...
class QuestionnairesControllerTest < ActionController::TestCase
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post :create, questionnaire: { effectiveFrom: @questionnaire.effectiveFrom, effectiveTo: @questionnaire.effectiveTo, id: @questionnaire.id, title: @questionnaire.title }
    end
  ...
  test "should update questionnaire" do
    put :update, id: @questionnaire, questionnaire: { effectiveFrom: @questionnaire.effectiveFrom, effectiveTo: @questionnaire.effectiveTo, id: @questionnaire.id, title: @questionnaire.title }
    assert_redirected_to questionnaire_path(assigns(:questionnaire))
  end
