PjSearch::Application.routes.draw do
  ...
  devise_scope :user do
    ...
    match 'user/:id' => 'users/registrations#destroy', :via => :delete, :as => :admin_destroy_user
	match 'user/:id/edit' => 'users/registrations#edit_auther', :as => :admin_edit_user
	#match 'user/:id' => 'users/registrations#show', as: :user
  end
